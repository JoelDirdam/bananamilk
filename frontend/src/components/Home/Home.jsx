...
import ChaimznSection from './ChaimznSection'
import AdaptiveCurve from './AdaptiveCurve'
...
const Home = () => {
  return (
    <div>
      {/* Primera Sección */}
      <div className='bg-hbg1 bg-cover bg-center h-[65vh] sm:h-[60vh] lg:h-[65vh] flex items-center justify-center px-4 sm:px-6 lg:px-0'>
        <div className='max-w-screen-xl w-full'>
          <div className='relative text-center'>
            <h1 className='absolute left-1/2 transform -translate-x-1/2 w-full gradient-text1 text-2xl sm:text-4xl md:text-5xl lg:text-7xl font-bold font-sanggar text-transparent bg-clip-text border-solid px-2 sm:px-0 md:px-2 xl:px-4'>Mercancía de kpop original y fanmade</h1>
            <h1 className='gradient-text1 text-2xl sm:text-4xl md:text-5xl lg:text-7xl font-bold font-sanggar text-transparent bg-clip-text px-2 sm:px-0 hero-title-stroke'
              style={{
                strokeLinecap: 'round',
            ...
            <p className='absolute left-1/2 transform -translate-x-1/2 text-banana-milk-text-light text-2xl sm:text-4xl md:text-5xl lg:text-7xl font-winkle z-0 px-2 sm:px-0'>
              cerquita de ti
            </p>
            <p className='text-banana-milk-text-light text-2xl sm:text-4xl md:text-5xl lg:text-7xl font-bold font-winkle z-0 px-2 sm:px-0 hero-subtitle-stroke'
              style={{
                top: '15%',
                strokeLinecap: 'round',
            ...
            <div className='mt-6 sm:mt-8 lg:mt-10'>
              ...
              } className='bg-banana-milk-text-light text-[#FF96B2] font-winkle text-base sm:text-xl md:text-2xl lg:text-3xl py-1.5 px-4 sm:py-2 sm:px-6 lg:py-2 lg:px-8 rounded-full'>Quiero comprar ya!</button>
            </div>
          </div>
        </div>
      </div>
      ...
      {/* Segunda Sección */}
      <div className='min-h-[70vh] py-8 sm:py-12 lg:py-0 lg:h-[70vh] flex flex-col items-center justify-center relative px-4 sm:px-6 lg:px-0'>
        <div className='max-w-screen-xl w-full'>
          <div className='flex flex-col sm:flex-row items-center justify-center text-center mb-8 sm:mb-12 lg:mb-16 gap-2 sm:gap-4 lg:gap-0'>
            <h1 className='gradient-text2 text-3xl sm:text-5xl md:text-6xl lg:text-7xl font-sanggar text-transparent bg-clip-text border-solid'>
              Lo que más nos piden
            </h1>
            <img src={Heart} alt="♥" className='ml-0 sm:ml-4 lg:ml-10 h-8 sm:h-12 lg:h-auto self-center -translate-y-0 sm:-translate-y-1 lg:-translate-y-2' />
          </div>

          {/* Centramos las imágenes con texto */}
          <div className='grid grid-cols-1 sm:grid-cols-2 lg:flex lg:justify-center gap-4 sm:gap-6 lg:gap-10 mt-6 sm:mt-8 lg:mt-10'>
            {/* Imagen 1 */}
            <div className='flex flex-col items-center group relative cursor-pointer'>
              ...
              <div className='absolute inset-0 flex items-center justify-center opacity-0 group-hover:opacity-100 transition-opacity duration-300 ease-in-out'>
                <p className='absolute text-wishlist1 font-winkle text-lg sm:text-2xl lg:text-4xl text-center'>quiero <br /> saber mas</p>
                <p className='text-white font-winkle text-lg sm:text-2xl lg:text-4xl text-center product-overlay-stroke'
                  style={{
                    strokeLinecap: 'round',
                    textShadow: '0 0 5px #FFFFFF, 0 0 10px #FFFFFF, 0 0 15px #FFFFFF'
                  }}
              ...
              <p className='text-center mt-2 sm:mt-3 lg:mt-4 text-sm sm:text-base lg:text-lg text-[#7AA9FF] underline decoration-[#7AA9FF] group-hover:decoration-[#FFAFE3] group-hover:text-[#FFAFE3] transition-all duration-300 ease-in-out'>
                Sticker pack Kpop
              </p>
            </div>
      ...
      {/* Tercera Sección */}
      <div className='min-h-[80vh] py-8 sm:py-12 lg:py-0 lg:h-[80vh] flex items-center justify-center bg-[#FFB8CB] relative px-4 sm:px-6 lg:px-0'>
        {/* Curva adaptativa que cambia según el tamaño de pantalla */}
        <AdaptiveCurve 
          strokeColor='#FF96B2' 
          fillColor='#FFF' 
          strokeWidth='30px'
        ...
        <div className='max-w-screen-xl relative z-10 w-full'>
          <div className='text-start'>
            <h1 className='text-white text-3xl sm:text-5xl md:text-6xl lg:text-7xl font-sanggar'>
              ¡Hola! Somos Cat y Marce, las <br className='hidden sm:block' /> fundadoras de Banana Milk.
            </h1>
            <div className='text-[#FFDEE7] font-winkle text-base sm:text-xl md:text-2xl lg:text-3xl'>
          ...
          <div className='text-center sm:text-end mt-6 sm:mt-8'>
            <button className='bg-banana-milk-text-light text-[#FF96B2] font-winkle text-base sm:text-xl lg:text-2xl py-1.5 px-4 sm:py-2 sm:px-6 lg:py-2 lg:px-8 rounded-full'>Sobre nosotras</button>
          </div>
        </div>
      </div>
      ...
      {/* Cuarta Sección */}
      <div className='min-h-[80vh] py-8 sm:py-12 lg:py-0 lg:h-[80vh] flex items-center justify-center relative px-4 sm:px-6 lg:px-0'>
        {/* Fondo como imagen */}
        ...
        <div className='max-w-screen-xl z-10 w-full'>
          <div className='text-center'>
            <h1 className='text-3xl sm:text-5xl md:text-6xl lg:text-7xl font-winkle text-white'>
              Productos para entrega inmediata en:
            </h1>

            <div className='flex flex-col sm:flex-row justify-around items-center mt-6 sm:mt-8 lg:mt-10 gap-4 sm:gap-6 lg:gap-2'>
              <div className='relative flex flex-col items-center group cursor-pointer'>
                ...
                <div className='relative'>
                  <p className='absolute text-white font-winkle text-lg sm:text-2xl lg:text-4xl mt-2 sm:mt-3 lg:mt-4 group-hover:text-[#B382D9]'>Durango, Dgo.</p>
                  <p className='inset-0 text-white font-winkle text-lg sm:text-2xl lg:text-4xl opacity-0 group-hover:opacity-100 transition-opacity duration-100 ease-in-out mt-2 sm:mt-3 lg:mt-4 city-name-stroke'
                    style={{
                      strokeLinecap: 'round',
                      textShadow: '0 0 5px #FFFFFF, 0 0 10px #FFFFFF, 0 0 15px #FFFFFF'
                    }}
