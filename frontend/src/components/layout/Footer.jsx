...
const Footer = () => {
  return (
    <div className="footer text-light text-center p-3">
      <div className="max-w-screen-xl mx-auto flex flex-col md:flex-row justify-between items-center py-8 gap-6 md:gap-0">

        {/* Primer apartado: Logo y derechos reservados */}
        <div className="flex flex-col items-center lg:items-start">
          <img src={Logo5} alt="Logo" className="w-[40%] sm:w-[50%] md:w-[60%] lg:w-[75%] mb-4" />
          <p className="text-[#B59EE8]">
            © 2024 Durango Dgo. Made by <a className="underline" href='https://www.instagram.com/chaimanzana_'>Chai Manzana</a>
          </p>
          <p className="text-[#EBC2F2] text-sm">
            Developed by <a className='underline' href="https://www.instagram.com/joeldirdam">@joeldirdam</a>
          </p>
          <p className="text-[#EBC2F2] text-sm">
            Designed by <a className='underline' href="https://www.instagram.com/marcesg_">@marcesg_</a>
          </p>
        </div>
